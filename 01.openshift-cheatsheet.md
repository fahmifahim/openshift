...
# Enable and apply the addon for httpasswd addon (MINISHIFT only)
$ minishift addon enable htpasswd-identity-provider
$ minishift addon apply htpasswd-identity-provider
$ minishift addon list

# Set password to developer01 and developer02 user (htpasswd)
$ minishift openshift config view
  # Make sure the identityProvider is "HTPasswdPasswordIdentityProvider"
$ minishift ssh
$ sudo su - 
$ htpasswd -b /var/lib/minishift/base/openshift-apiserver developer01 [password-for-developer01]
$ htpasswd -b /var/lib/minishift/base/openshift-apiserver developer02 [password-for-developer02]
