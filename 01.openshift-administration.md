...
3. Configure new application `todo-http2` with secure passthrough route using the provided CA and self-signed certificate.  
  ...
  - Configure the route as `todo-https-passthrough.apps.ocp4.example.com`  
  - 


```bash  
#Generate key  
openssl genrsa -key training.key 2048
