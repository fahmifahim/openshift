...
6. Extract the current `localusers` secret to htpasswd file at /tmp/htpasswd-mgr. Add `manager` user with password `manager`. Update the secret and make sure you can login with manager user.  
